    ...
    <tr>
        <td background="{{ asset('assets/pages/mail/images/bg.jpg') }}" bgcolor="#494c50" valign="top" style="background-size: cover; background-position: center;">
            <table border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <!-- content -->
                <tr>
                    <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:11px; color:#FFFFFF;text-transform:uppercase; letter-spacing:4px;"></td>
                </tr>
                <!-- end content -->
                <tr>
                    <td height="40"></td>
                            ...
                            <tr>
                                <td align="center">
                                    <table align="center" width="90%" border="0" cellspacing="0" cellpadding="0">
                                        <!-- title -->
                                        <tr>
                                            <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:36px; color:#3b3b3b; font-weight: bold; letter-spacing:4px;">  </td>
                                        </tr>
                                        <!-- end title -->
                                        <tr>
                                            <td align="center">
                ...
                <tr>
                    <td height="22" align="center" style="line-height:0px;">
                        <img src="" alt="img" width="42" height="22" style="display:block; line-height:0px; font-size:0px; border:0px;" />
                    </td>
                </tr>
                <tr>
                    <td height="30"></td>
                        ...
                        <table align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" style="line-height:0xp;">
                                    <a href="javascript:;"> <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" alt="Facebook" /> </a>
                                </td>
                                <td width="20"></td>
                                <td align="center" style="line-height:0xp;">
                                    <a href="javascript:;"> <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" alt="Twitter" /> </a>
                                </td>
                                <td width="20"></td>
                                <td align="center" style="line-height:0xp;">
                                    <a href="javascript:;"> <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" alt="Google Plus" /> </a>
                                </td>
                                <td width="20"></td>
                                <td align="center" style="line-height:0xp;">
                                    <a href="javascript:;"> <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" alt="LinkedIn" /> </a>
                                </td>
                                <td width="20"></td>
                                <td align="center" style="line-height:0xp;">
                                    <a href="javascript:;"> <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" alt="Bëhance" /> </a>
                                </td>
                                <td width="20"></td>
                                <td align="center" style="line-height:0xp;">
                                    <a href="javascript:;"> <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="" alt="Dribbble" /> </a>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <!-- copyright -->
                <tr>
                    <td align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#FFFFFF;">© . All Rights Reserved.</td>
                </tr>
                <!-- end copyright -->
                <tr>
                    <td height="30"></td>
